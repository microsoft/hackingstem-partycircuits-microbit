...
#  For use with the Making party lights to understand electrical circuits and switches lesson plan for electricity basics
...
#  https://github.com/microsoft/hackingstem-partycircuits-microbit
#
